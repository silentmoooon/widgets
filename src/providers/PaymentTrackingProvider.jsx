  ...
  const trace = (afterBlock, paymentRoute, transaction, deadline)=>{
    ...
    return new Promise(async(resolve, reject)=>{
      let performedPayment = {
        ...
        after_block: afterBlock.toString(),
        from_token: paymentRoute.fromTokens[0].fromToken.address,
        from_amount: paymentRoute.fromTokens[0].fromAmount.toString(),
        from_decimals: paymentRoute.fromTokens[0].fromDecimals,
        to_token: paymentRoute.fromTokens[0].toToken.address,
        to_amount: paymentRoute.fromTokens[0].toAmount.toString(),
        to_decimals: paymentRoute.fromTokens[0].toDecimals,
        fee_amount: paymentRoute?.fromTokens[0].feeAmount?.toString(),
        deadline,
        selected_wallet: wallet?.name
      }
      if(configurationId){
